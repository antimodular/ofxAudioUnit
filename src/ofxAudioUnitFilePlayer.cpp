...
void ofxAudioUnitFilePlayer::resetToStart(){

    //added this function because i want to send a new play call without the overhead that prime() seems to cause
    //when using 700 files calls to play slow the system down a lot
...
int ofxAudioUnitFilePlayer::getStartTimestamp()
{
    AudioTimeStamp timeStamp ; //= {0};
    UInt32 timeStampSize = sizeof(AudioTimeStamp);
